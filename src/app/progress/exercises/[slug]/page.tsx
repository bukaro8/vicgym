...
export default async function ExerciseProgressPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const data = await getExerciseHistory(getPrisma(), user.id, slug);
  if (!data) notFound();
